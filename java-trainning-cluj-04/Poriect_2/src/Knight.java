...
public class Knight extends Piece {
    ...
    List<Pair<Integer, Integer>> moves(int x, int y) {
        List<BiFunction<Integer, Integer, Pair<Integer, Integer>>> allMoves = Arrays.asList((z, t) -> new Pair<>(z - 2, t + 1),
                (z, t) -> new Pair<>(z - 1, t + 2), (z, t) -> new Pair<>(z - 2, t - 1),
                (z, t) -> new Pair<>(z + 1, t - 2), (z, t) -> new Pair<>(z + 2, t - 1),
                (z, t) -> new Pair<>(z + 2, t + 1), (z, t) -> new Pair<>(z + 1, t + 2),
                (z, t) -> new Pair<>(z - 1, t - 2));
    ...
    void fixImage() {
        if (this.isBlack) {
            this.pieceIcon = new ImageIcon("ImaginiPiese/calNegru.png");
        } else {
            this.pieceIcon = new ImageIcon("ImaginiPiese/calAlb.png");
        }
